...
export default function Login() {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-red-500 to-purple-700 w-full flex justify-center items-center">
      <div className="flex flex-col gap-6 bg-neutral-900 p-20 text-center rounded-lg">
      <div className="flex h-16 justify-center"><img src={logo2} /></div>
